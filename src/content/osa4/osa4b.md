...
Huomaa, että joudut tekemään koodiin [materiaalin tapaan](http://localhost:8000/osa4/backendin_testaaminen#test-ymparisto) hieman muutoksia (mm. testausympäristön määrittely), jotta saat järkevästi tehtyä omaa tietokantaa käyttäviä API-tason testejä.
